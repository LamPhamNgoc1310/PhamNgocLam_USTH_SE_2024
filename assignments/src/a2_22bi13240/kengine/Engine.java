 ...
 *           the exception contains a string explaining the problem. All
 *           instance methods modify the state of <code>this</code>.
 * 
 * 
...
public class Engine {
	 ...
	 *          initialises the application state appropriately
	 */
	 ...
	 * documents of a given keyword <code>w</code>
	 * 
	 * @param w a keyword to search
	 * @effects if <code>w</code> is not a word or <code>w</code> is an
	 *          uninteresting word then throws <code>NotPossibleException</code>,
	 *          else returns a <code>Query</code> object containing the documents
	 ...
	 * object for those that contains an additional keyword <code>w</code>
	 * 
	 * @param w a keyword to search
	 * @effects if <code>w</code> is not a word or <code>w</code> is an
	 *          uninteresting word then throws <code>NotPossibleException</code>,
	 *          else returns an updated <code>Query</code> object containing the
	 *          documents matching all keywords
	 * @version 4.0
	 */
	 ...
	 * @effects if <code>t</code> is not in <code>TitleTable</code> then throw
	 *          <code>NotPossibleException</code>, else return the <code>Doc</code>
	 *          object with title <code>t</code>
	 */
	 ...
	 *          or <code>u</code> is one of the existing URLs throws
	 ...
	 *          contains any matching new documents.
	...
	/**
	 * @effects if tt is empty return null else return Iterator(Doc) for documents
	 *          in tt
	 * 
	...
	/**
	 * @effects if d is null throws <code> NullPointerException </code> else add d
	 *          to this.tt and this.wt using their respective methods. if this.q is
	 *          not null update this.q to contain any new matching documents. return
	 *          this.q
	 */
	public Query addDoc(Doc d) throws NullPointerException {
		if(d == null) 
			throw new NullPointerException("Engine.addDoc: Your document is empty!");
		this.wt.addDoc(d);
